...
class BundleCustomFieldsCest
{
	 ...
	 * @param   AcceptanceTester $I  Tester.
	 */
	public function testMemberCustomFieldsWhenBundleAdded(AcceptanceTester $I)
	{
		// Create a product.
	 ...
	 * @param   AcceptanceTester $I  Tester.
	 */
	public function testMemberCustomFieldsWhenBundleReactivated(AcceptanceTester $I)
	{
		// Create a product.
		$productID = $I->memberMouseCreateProduct($I, 'Product', $_ENV['MEMBERMOUSE_PRODUCT_REFERENCE_KEY']);
